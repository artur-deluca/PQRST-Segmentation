...
def predict_plotter(x, pred, y):
    ...
    #colored_lines_pred = LineCollection(lines, colors=color_table_pred)
    #colored_lines_y = LineCollection(lines, colors=color_table_y)
    ...
    #ax2.scatter(range(x.shape[0]), x, c=color_table_y, s=1)
